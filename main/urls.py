...
urlpatterns = [
  ...
  path('intro/program_description/data_science', views.python_description, name='ds-description'),
  path('intro/program_description/web_publishing', views.python_description, name='htmlcss-description'),
