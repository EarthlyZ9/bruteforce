...
urlpatterns = [
  ...
  path('htmlcss_outputs/create_feedback/<int:fruit_id>', views.create_feedback, name='create-feedback'), #feedback 등록하기
  path('htmlcss_outputs/feedbacks/', views.load_feedbacks, name='htmlcss-feedbacks'), #feedback 보여주기
