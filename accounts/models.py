...
"""
  ...
  individual = models.BooleanField(default=False, null = True, blank=True, help_text="데이터 사이언스 코스의 경우 스터디 활동이 필수이며, 웹 퍼블리싱 코스는 개인 단위로 이루어집니다. 파이썬 코스를 개인 단위로 수강하고자 하시는 분들은 체크해주세요! ")
  ...
  purchase = models.BooleanField(default=False, help_text="구매안내 어쩌고 저ㄱㅉ거 구매한 사람 체크 안했으면 가서 구매하기~")
