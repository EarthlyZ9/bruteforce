...
urlpatterns = [
    ...
    path(
        ...
        question_views.modify_question,
    ...
    path(
        ...
        answer_views.create_answer,
        name="create-answer",
    ),
    path(
        "answer/modify/<int:answer_id>/",
        answer_views.modify_answer,
        name="modify-answer",
    ),
    path(
        "answer/delete/<int:answer_id>/",
        answer_views.delete_answer,
        name="delete-answer",
    ),
    # comment_views
    path(
        "comment/create/answer/<int:answer_id>/",
        comment_views.create_answer_comment,
        name="create-answer-comment",
    ),
    path(
        "comment/modify/answer/<int:comment_id>/",
        comment_views.modify_answer_comment,
        name="modify-answer-comment",
    ),
    path(
        "comment/delete/answer/<int:comment_id>/",
        comment_views.delete_answer_comment,
        name="delete-answer-comment",
    ),
    # vote_views
