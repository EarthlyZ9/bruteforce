...
"""
    ...
    individual = models.BooleanField(
        ...
        null=True,
        blank=True,
        help_text="파이썬 코스를 개인 단위로 수강하고자 하시는 분들은 체크해주세요! (데이터 사이언스 코스의 경우 스터디 활동이 필수이며, 웹 퍼블리싱 코스는 개인 단위로 이루어집니다.)",
    )
    ...
    purchase = models.BooleanField(
        default=False,
        help_text="BruteForce 프로그램에 참여하기 위해서는 멤버십 구매가 필요합니다. 구매를 완료하셨다면 체크해주세요!",
    )
    privacy_policy_1 = models.BooleanField(
        default=False, help_text=PRIVACY_POLICY_CONTENT_1
    )
    privacy_policy_2 = models.BooleanField(
        default=False, help_text=PRIVACY_POLICY_CONTENT_2
    )
    ...
    bank_name = models.CharField(
        max_length=20, choices=BANK_LIST, null=True, blank=True, default="입력전"
    )
